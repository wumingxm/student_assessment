	...
	<div class="containerfluid">
		<div style="height:90px;widht:100%;" id="top" >
			<img src="../img/ydzy.jpg" id="logo" /> <span id="sysName"
				style="font-family:楷体;font-size:30px;"">延安大学学生评价管理系统</span> <span id="welcome" style="position:absolute;right:100px;top:10px;">欢迎${userName}登录！</span>
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				...
				<li class="dropdown"><a class="dropdown-toggle" href="#"
					...
					<ul class="dropdown-menu">
						<li><a
							href="${pageContext.request.contextPath}/selectCourseAll?page=1&pageSize=8">课程信息管理</a></li>
						<li><a
